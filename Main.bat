...
REM Check if the startup_winvnc.bat was created
...
REM Check if the run_winvnc.bat was created
...
REM Confirm folder hiding
if exist "%script_dir%\.." (
  echo Parent folders hidden successfully.
) else (
  echo Failed to hide parent folders.
)
